...
<head>
    ...
    <title>Create Journal - Library</title>
                    ...
                    <div class="card-body">
                        <form action="{{ route('journals.store') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="5" placeholder="Enter Journal Description">{{ old('description') }}</textarea>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control @error('is_accessible') is-invalid @enderror" name="is_accessible">
                                    <option value="requested" {{ old('is_accessible') == 'requested' ? 'selected' : '' }}>Requested</option>
                                    <option value="granted" {{ old('is_accessible') == 'granted' ? 'selected' : '' }}>Granted</option>
                                    <option value="denied" {{ old('is_accessible') == 'denied' ? 'selected' : '' }}>Denied</option>
                                </select>
