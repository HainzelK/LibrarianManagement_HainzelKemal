                    ...
                    <div class="card-body">
                        <form action="{{ route('books.update', $book->id) }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('category') is-invalid @enderror" name="category" value="{{ old('category', $book->category) }}" placeholder="Enter Book Category">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control @error('is_physical') is-invalid @enderror" name="is_physical">
                                    <option value="1" {{ old('is_physical', $book->is_physical) == 1 ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ old('is_physical', $book->is_physical) == 0 ? 'selected' : '' }}>No</option>
                                </select>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control @error('available') is-invalid @enderror" name="available">
                                    <option value="1" {{ old('available', $book->available) == 1 ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ old('available', $book->available) == 0 ? 'selected' : '' }}>No</option>
                                </select>
